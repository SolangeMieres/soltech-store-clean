  ...
  return (
    <nav className="flex items-center justify-between px-8 py-4 bg-dark shadow-soft sticky top-0 z-50">
      ...
      <div className="flex items-center gap-6 text-light/80 text-sm">
        <a href="#" className="hover:text-brand transition">{t.home}</a>
        <a href="#productos" className="hover:text-brand transition">{t.products}</a>
        <a href="#contacto" className="hover:text-brand transition">{t.contact}</a>
