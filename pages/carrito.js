...
export default function Carrito() {
  // Asegúrate de que useCart exporte isLoaded
  ...
  // 2. Si el carrito está vacío (Solo se comprueba después de la carga)
  if (cart.length === 0)
    return (
  ...
  // 3. 💳 Carrito con productos (Aparece el botón de compra)
  return (
      ...
      <div className="mt-6 border-t border-cyan-700/30 pt-4 text-right">
        ...
        <div className="flex justify-end gap-3 mt-4">
          ...
          <button
            ...
            disabled={loading || cart.length === 0} // Añadido disable si carrito vacío
